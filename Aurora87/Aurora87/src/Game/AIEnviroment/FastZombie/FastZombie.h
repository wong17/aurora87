...
#include "Game/AIEnviroment/FastZombie/Mechanics/ZombieFastSleep.h"
...
{
	class FastZombie : public BaseGameEntity, public EventListener
	{

	private:
		FiniteStateFastZombie* m_CurrentStateFastZombie;
		float m_speed;
		float m_health;
		glm::vec3 m_position;
